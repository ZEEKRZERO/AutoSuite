...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(tooltip)
        self.action_send_data.setText(QCoreApplication.translate("MainWindow", u"Send bus data", None))
#if QT_CONFIG(tooltip)
        self.action_send_data.setToolTip(QCoreApplication.translate("MainWindow", u"Send bus data", None))
#endif // QT_CONFIG(tooltip)
        self.action_dbcDecode.setText(QCoreApplication.translate("MainWindow", u"Import CAN database", None))
#if QT_CONFIG(tooltip)
        self.action_dbcDecode.setToolTip(QCoreApplication.translate("MainWindow", u"Import CAN database", None))
#endif // QT_CONFIG(tooltip)
        self.action_addFlexRayDB.setText(QCoreApplication.translate("MainWindow", u"Import the FlexRay database", None))
#if QT_CONFIG(tooltip)
        self.action_addFlexRayDB.setToolTip(QCoreApplication.translate("MainWindow", u"Import the FlexRay database", None))
#endif // QT_CONFIG(tooltip)
        self.action_addLinDB.setText(QCoreApplication.translate("MainWindow", u"Import LIN database", None))
#if QT_CONFIG(tooltip)
        self.action_addLinDB.setToolTip(QCoreApplication.translate("MainWindow", u"Import LIN database", None))
#endif // QT_CONFIG(tooltip)
        self.action_addEthernetDB.setText(QCoreApplication.translate("MainWindow", u"Importing Ethernet database", None))
#if QT_CONFIG(tooltip)
        self.action_addEthernetDB.setToolTip(QCoreApplication.translate("MainWindow", u"Importing Ethernet database", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.menu.setTitle(QCoreApplication.translate("MainWindow", u"Equipment management", None))
        self.menu_2.setTitle(QCoreApplication.translate("MainWindow", u"Help", None))
        self.menu_3.setTitle(QCoreApplication.translate("MainWindow", u"Function list", None))
        self.menu_4.setTitle(QCoreApplication.translate("MainWindow", u"Data management", None))
