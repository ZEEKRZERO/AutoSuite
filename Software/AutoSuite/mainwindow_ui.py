...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/help.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_helpDoc.setIcon(icon4)
        self.action_about = QAction(MainWindow)
        self.action_about.setObjectName(u"action_about")
        icon5 = QIcon()
        icon5.addFile(u":/icons/about.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/basicData.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.action_rawDis.setIcon(icon6)
        self.action_sniff = QAction(MainWindow)
        self.action_sniff.setObjectName(u"action_sniff")
        self.action_sniff.setCheckable(True)
        icon7 = QIcon()
        icon7.addFile(u":/icons/dataSniff.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.action_sniff.setIcon(icon7)
        self.action_historyQuery = QAction(MainWindow)
        self.action_historyQuery.setObjectName(u"action_historyQuery")
        icon8 = QIcon()
        icon8.addFile(u":/icons/dataQuery.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.action_historyQuery.setIcon(icon8)
        self.action_dbcDecode = QAction(MainWindow)
        self.action_dbcDecode.setObjectName(u"action_dbcDecode")
        self.action_dbcDecode.setCheckable(True)
        icon9 = QIcon()
        icon9.addFile(u":/icons/dbcDeocde.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.action_dbcDecode.setIcon(icon9)
        self.action_send_data = QAction(MainWindow)
        self.action_send_data.setObjectName(u"action_send_data")
        self.action_send_data.setCheckable(True)
        icon10 = QIcon()
        icon10.addFile(u":/icons/send.png", QSize(), QIcon.Normal, QIcon.On)
        self.action_send_data.setIcon(icon10)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1680, 27))
        ...
        self.menu_3.addAction(self.action_dbcDecode)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"ZEEKR\u5b89\u5168\u5b9e\u9a8c\u5ba4AutoSuite\u5b89\u5168\u6d4b\u8bd5\u5e73\u53f0v1.0", None))
        ...
        self.action_Connect.setText(QCoreApplication.translate("MainWindow", u"&\u8fde\u63a5\u8bbe\u5907", None))
#if QT_CONFIG(tooltip)
        self.action_Connect.setToolTip(QCoreApplication.translate("MainWindow", u"Connect", None))
#endif // QT_CONFIG(tooltip)
        self.action_Disconnect.setText(QCoreApplication.translate("MainWindow", u"&\u5173\u95ed\u8fde\u63a5", None))
#if QT_CONFIG(tooltip)
        self.action_Disconnect.setToolTip(QCoreApplication.translate("MainWindow", u"Disconnect", None))
#endif // QT_CONFIG(tooltip)
        self.action_connectParamSet.setText(QCoreApplication.translate("MainWindow", u"\u8fde\u63a5\u53c2\u6570\u8bbe\u7f6e", None))
#if QT_CONFIG(tooltip)
        self.action_connectParamSet.setToolTip(QCoreApplication.translate("MainWindow", u"\u8fde\u63a5\u53c2\u6570\u8bbe\u7f6e", None))
#endif // QT_CONFIG(tooltip)
        self.action_helpDoc.setText(QCoreApplication.translate("MainWindow", u"\u5e2e\u52a9\u6587\u6863", None))
#if QT_CONFIG(tooltip)
        self.action_helpDoc.setToolTip(QCoreApplication.translate("MainWindow", u"\u5e2e\u52a9\u6587\u6863", None))
#endif // QT_CONFIG(tooltip)
        self.action_about.setText(QCoreApplication.translate("MainWindow", u"\u5173\u4e8e\u6211\u4eec", None))
#if QT_CONFIG(tooltip)
        self.action_about.setToolTip(QCoreApplication.translate("MainWindow", u"\u5173\u4e8e\u6211\u4eec", None))
#endif // QT_CONFIG(tooltip)
        self.action_rawDis.setText(QCoreApplication.translate("MainWindow", u"\u539f\u59cb\u6570\u636e\u89c6\u56fe", None))
        self.action_sniff.setText(QCoreApplication.translate("MainWindow", u"\u6570\u636e\u6293\u53d6", None))
#if QT_CONFIG(tooltip)
        self.action_sniff.setToolTip(QCoreApplication.translate("MainWindow", u"\u6570\u636e\u6293\u53d6", None))
#endif // QT_CONFIG(tooltip)
        self.action_historyQuery.setText(QCoreApplication.translate("MainWindow", u"\u5386\u53f2\u6570\u636e\u67e5\u8be2", None))
        self.action_dbcDecode.setText(QCoreApplication.translate("MainWindow", u"\u4fe1\u53f7FUZZ", None))
#if QT_CONFIG(tooltip)
        self.action_dbcDecode.setToolTip(QCoreApplication.translate("MainWindow", u"\u4fe1\u53f7FUZZ", None))
#endif // QT_CONFIG(tooltip)
        self.action_send_data.setText(QCoreApplication.translate("MainWindow", u"\u53d1\u9001\u6570\u636e", None))
#if QT_CONFIG(tooltip)
        self.action_send_data.setToolTip(QCoreApplication.translate("MainWindow", u"send data", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_clearAppPrint.setText(QCoreApplication.translate("MainWindow", u"\u6e05\u7a7a\u8f93\u51fa", None))
        self.groupBox.setTitle("")
        self.tabWidget_info.setTabText(self.tabWidget_info.indexOf(self.tab_3), QCoreApplication.translate("MainWindow", u"\u8f93\u51fa", None))
        self.tabWidget_info.setTabText(self.tabWidget_info.indexOf(self.tab_4), QCoreApplication.translate("MainWindow", u"\u7ec8\u7aef", None))
        self.menu.setTitle(QCoreApplication.translate("MainWindow", u"\u8bbe\u5907\u7ba1\u7406", None))
        self.menu_2.setTitle(QCoreApplication.translate("MainWindow", u"\u5e2e\u52a9", None))
        self.menu_3.setTitle(QCoreApplication.translate("MainWindow", u"\u529f\u80fd\u89c6\u56fe", None))
        self.menu_4.setTitle(QCoreApplication.translate("MainWindow", u"\u5386\u53f2\u6570\u636e", None))
